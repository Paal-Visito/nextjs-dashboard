            ...
            <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
                <div className="flex flex-col justify-center gap-6 px-6 py-10 md:w-2/5 md:px-20">
                    <Link href="/login">
                        ...
                        <Button
                            variant="outline"
                            className="flex items-center gap-5 self-start border-white rounded-lg bg-black px-20 py-10 text-white transition-colors hover:bg-gray-700 md:text-base"
                        >
                            <span className='text-3xl font-bold'>Log in</span>
                            <ArrowRightIcon style={{ height: '30px', width: '30px' }} />
                        </Button>
                    </Link>
                </div>
